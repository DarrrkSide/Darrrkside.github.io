/* Shared site behavior: mobile nav toggle + active-link marking + Discord FAB. */
(function () {
  // Floating Discord button — fixed to the bottom-right corner, present on
  // every page since every page loads this script.
  const discordLink = document.createElement("a");
  discordLink.href = "https://discord.gg/BKCGYKHcN";
  discordLink.target = "_blank";
  discordLink.rel = "noopener";
  discordLink.className = "discord-fab";
  discordLink.setAttribute("aria-label", "Join the Discord server");
  discordLink.title = "Join the Discord server";
